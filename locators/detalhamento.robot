...
${detalhamento_table_resultados}
...                                             xpath://table[@class='mat-table cdk-table mat-sort generic-table']/tbody/tr
${detalhamento_link_opcao_det}                  xpath://a[text()='Detalhamento']
${detalhamento_table_last_td_element}
...                                             xpath://table[@class='mat-table cdk-table mat-sort generic-table']/tbody/tr[1]/child::td[position()=last()]
...
${detalhamento_checkbox_first_variable}
...                                             xpath://div[@class='variable-table-values-wrapper']/div[1]/div/div[@class='column-check']
...
${detalhamento_primeira_variavel}
...                                             xpath://div[contains(@class, 'variable-table-values-wrapper')]/div[1]/div/div[@class='column-key']
${detalhamento_table_variaveis}                 xpath://div[contains(@class, 'variable-table-values-wrapper')]
${detalhamento_valor_processado}
...                                             xpath://div[contains(@class, 'variable-table-values-wrapper')]/div[1]/div/div[@class='column-value']
...
${detalhamento_trace_background_message}
...                                             //app-trace-details//mat-tab-body/div/div/app-background-message//span[.=' Selecione uma linha para exibir informações aqui. ']
