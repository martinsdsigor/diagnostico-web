...
${submissao_menu_relatorio_cobertura}
...                                                 //span[.='Relatório de cobertura
...                                                 ']/parent::a
${submissao_menu_graficos}
...                                                 //span[.='Gráficos ']/parent::a[contains(@href, '/graphs')]
${submissao_botao_exportar_relatorio}
...                                                 //b[.='EXPORTAR RELATÓRIO']/parent::span/parent::button
${submissao_botao_detalhamento_do_teste}            //button[.=' Detalhamento do teste ']
${submissao_texto_itens_por_pagina}                 //div[text()=' Itens por página ']
${submissao_select_itens_por_pagina}                //mat-select[@role='combobox']
